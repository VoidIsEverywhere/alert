...
class scrapper:
    ...
    def check_if_element_is_there(self, xpath, driver):
    ...
    def wait_for_element(self, xpath, how_long_to_wait, driver):
    ...
    def rand_type(self, string, xpath, driver):
    ...
    def type(self, string, xpath, driver):
        """Types passed string to the element passed at random speeds."""
        element = driver.find_element_by_xpath(xpath)
        if string == "ENTER":
    ...
    def get_text(self, xpath, driver):
        """Get the text from the passed xpath."""
        element_present = self.check_if_element_is_there(xpath, driver)
    ...
    def get_texts(self, xpath, driver):
    ...
    def click_thro(self, xpath, driver):
